...
### Шинэ фолдерт холболтын тохиргоо хийж эхлүүлэх

| Command | Description |
| ------- | ----------- |
| `git init` | git үүсгэх |
| `git config --global user.name "Name"` | "Name"-ийн оронд өөрийн нэр оруулна (github дээрх нэрээ оруулах)  |
| `git config --global user.email "user@example.com"` | e-mail хаягаа оруулах (github руу нэвтрэх) |
